...
export class PostService {
    ...
    constructor(
        ...
        @InjectModel(Doctor.name, 'userConnection') private doctorModel: Model<Doctor>,
        @InjectModel(Post.name, 'userConnection') private postModel: Model<Post>,
    ...
    // TODO: Uncomment when VectorSearchService is available
    ...
    // TODO: Uncomment when EmbeddingService and QdrantService are available
    // trong PostService
    ...
    // TODO: Uncomment when QdrantService is available
    ...
    async searchPosts(query: string) {
        // Fallback to basic search when embedding service is not available
    ...
    // Stub methods for embedding-related features
    async findSimilarPosts(postId: string, limit: number = 5, minSimilarity: number = 0.7): Promise<Array<{ post: Post; similarity: number }>> {
        // TODO: Implement when VectorSearchService is available
        this.logger.warn('findSimilarPosts is not implemented - EmbeddingService required');
        return [];
    }

    async hybridSearch(q: string, limit = 5, minSimilarity = 0.75) {
        // TODO: Implement when EmbeddingService is available
        this.logger.warn('hybridSearch is not implemented - EmbeddingService required');
    ...
    async generateAndStoreEmbedding(postId: string, keywords?: string, content?: string): Promise<void> {
        // TODO: Implement when EmbeddingService is available
        this.logger.warn('generateAndStoreEmbedding is not implemented - EmbeddingService required');
    }

    async generateEmbeddingAsync(postId: string, keywords?: string, content?: string): Promise<void> {
        // TODO: Implement when EmbeddingService is available
        this.logger.warn('generateEmbeddingAsync is not implemented - EmbeddingService required');
    }
}
