...
import { UpdateKeywordsDto, UpdatePostDto } from 'apps/post/src/core/dto/updatePost.dto';
...
export class PostController {
  ...
  async hasKeywords(@Param('id') id: string) {
    return this.postService.hasKeywords(id);
  }

  @Get('has-embedding/:id')
  async hasEmbedding(@Param('id') id: string) {
    return this.postService.hasEmbedding(id);
  }
